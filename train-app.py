...
class TrainApp:
    ...
    def fetch_data(self):
        ...
        for t in trains:
            ...
            # 只顯示「尚未發車」或「剛發車」的車次（目前時間前10分鐘到未來的所有車）
    ...
    def generate_html(self, data):
        ...
        <head>
            ...
            <meta http-equiv="refresh" content="60"> <title>智慧火車時刻表</title>
            <style>
                ...
                .main-time { display: flex; align-items: center; justify-content: center; font-size: 2.6rem; font-weight: 900; letter-spacing: -1px; }
...
if __name__ == "__main__":
    if not CLIENT_ID or not CLIENT_SECRET:
        print("錯誤：找不到 API 金鑰。請確認環境變數 TDX_ID 與 TDX_SECRET 已設定。")
    else:
